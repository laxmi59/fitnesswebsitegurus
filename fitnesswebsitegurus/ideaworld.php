...
$array_subs_amounts= array("1"=>"29.99","2"=>"49.99","3"=>"69.99");
	...
	if(trim($submit_type) == 1)
	 {
		...
		$inv_sql = "INSERT INTO invitations(code,email,dt_created) VALUE ('$inv_code','$email',now())";
...
<div id="primary">
  <div id="content" role="main"  class="checkout">
    ...
    <form name="orderform" id="orderform" method="post">
      ...
      <div class="text">Being a personal trainer these days is hard enough without having to worry about your online presence. Luckily, that's where we come in. If  you're struggling with your business because of the sluggish economy, or you simply want to give yourself a competitive edge in a high demand field, look no further. At <a href="http://fitnesswebsitegurus.com">Fitness Website Gurus</a>, we can get you the exposure you desire and help you take advantage of the huge market for personal trainers by custom-designing and developing a website that is geared towards maximizing your client base.</div>
      <div class="how-it-works">
        <div class="r-sec">
          <h2>How It Works</h2>
          <ol>
            <li> Select a package and get exclusive Idea World pricing</li>
            <li> Enter billing information</li>
            <li> Select a payment option<br />
              <span class="arrow-bullet">Pay now and get a free month&rsquo;s service</span> <span class="note">(requires billing information and payment information) </span> <span class="arrow-bullet">Pay later</span> <span class="note">(requires only billing information)</span> </li>
            <li> An email will be sent to you with the instructions on <br />
      ...
      <div class="packagebox">
        <ul>
          <li class="head"><span class="col1 pkgtitle">Package Details</span><span class="col2"><span class="bronze-badge"></span><span class="checkbox">
            <input type="radio" name="pkg_type" value="1" <?php if(trim($pkg_type) == "1") echo "checked";?> tabindex="1">
            </span></span><span class="col3"><span class="silver-badge"></span><span class="checkbox">
            <input type="radio" name="pkg_type" value="2" <?php if(trim($pkg_type) == "2") echo "checked";?> tabindex="1">
            </span></span><span class="col4"><span class="gold-badge" ></span><span class="checkbox">
      ...
      <div class="subtitle"> Enter your payment information below to pay now and receive a free month of service!</div>
        ...
        <div class="p28">
          <ul class="form">
            ...
            <li class="frmclr f-none  ">
              ...
              <input type="button" name="b2" value="paynow" class="paynow-btn f-right" onClick="return chkvalid('2')";/>
