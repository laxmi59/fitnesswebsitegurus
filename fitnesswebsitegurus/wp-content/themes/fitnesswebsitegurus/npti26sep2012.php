...
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.8.1/jquery.min.js"></script>
  ...
  <div id="unblockable_content" class="unblockable">
  	<span class="closebtn" id="unblockable_close_btn"><input type="button" name="unblockable_closeX" id="unblockable_closeX" value="X" /></span>
  	<h1 class="popup-thx">THANKS FOR VISITING!</h1>
  <form id="newsform" method="post">
  	<table class="unblockabletable">
    <tr><td width="200">
  	<label>Before you go, provide your email<br /> address for a free consultation at a<br /> later date. No obligation necessary.</label><br>
  	<input type="text" name="newemail" placeholder="Email Address" id="newemail" class="popinput" /><br><br>
	<label>How many days from now would<br /> you like to be consulted?</label><br>
	...
	<div style="position: absolute; top: 200px; right: 20px;"><input id="unblockable_closesubmit" class="popup-btn" type="button" name="submit" value="Submit" onClick="submit_form(this.form)" />
    &nbsp;&nbsp;
...
<div class="popupul">
<ul>
    <li><span id="my-button">See Bronze Package Examples</span></li>
	<li><span id="my-button1">See Silver Package Examples</span></li>
	<li><span id="my-button2">See Gold Package Examples</span></li>
</ul>	
</div>
...
<div id="bronzescreenpopupbig<?php echo $j?>" class="bronzescreenpopupbig">
    ...
    <a class="bClose1">x</a>
	<img src="<?php bloginfo( 'template_url' );?>/images/bronze_package/<?php echo $bronze_arr_img[$i]?>_screen.jpg" width="900">   
</div>
<?php }?>
...
<div id="silverscreenpopupbig<?php echo $j?>" class="silverscreenpopupbig">
	...
	<?php }?>
    <a class="bClose2">x</a>
	<img src="<?php bloginfo( 'template_url' );?>/images/silver_package/<?php echo $silver_arr_img[$i]?>_screen.jpg" width="900">   
</div>
<?php }?>
...
<div id="goldscreenpopupbig<?php echo $j?>" class="goldscreenpopupbig">
	...
	<?php }?>
    <a class="bClose3">x</a>
	<img src="<?php bloginfo( 'template_url' );?>/images/gold_package/<?php echo $gold_arr_img[$i]?>_screen.jpg" width="900">   
</div>
<?php }?>
            ...
            <li>
              ...
              <li>
                ...
                <input type="hidden" name="promo_status" id="promo_status" />
              	<input type="text" name="promo_code" class="input375" onkeyup="return chkthepromoavalability(this)" autocomplete="off"/>
              </li>
              </ul>
            </li>             
          </ul>
