...
<div class="yinstr">
    <p>{#tagwrap_dlg.noteCol}</p>
    <p>{#tagwrap_dlg.noteCol2}</p>
</div>
<form onSubmit="TagwrapDialog.insert();return false;" action="#" method="post" name="Col_tag">
<div class="mceActionPanel">
<script type="text/javascript" language="javascript">
var jwl_sel_content4 = tinyMCE.activeEditor.selection.getContent();
</script>

{#tagwrap_dlg.noteCol1} <input id="title_value" type="text" name="title" width="200px" value="" />
<br /><br />
</div>
...
<div class="mceActionPanel">
  ...
  <input type="button" id="insert" name="insert" value="{#insert}" onClick="jwl_pass_form_data();tinyMCE.execCommand('mceInsertContent',false,'<col width=\'' + jwl_title + '\'>' + jwl_sel_content4 + '</col>');tinyMCEPopup.close();" />&nbsp;<input type="button" id="cancel" name="cancel" value="{#cancel}" onClick="tinyMCEPopup.close();" />
  </div>
</div>
</form>
