<head>
<title>{#tagwrap_dlg.titleA}</title>
...
<div class="yinstr">
    <p>{#tagwrap_dlg.noteA}</p>
    <p>{#tagwrap_dlg.noteA3}</p>
</div>
...
{#tagwrap_dlg.noteA1} <input id="href_value" type="text" name="href" value="http://" />
<br /><br />
{#tagwrap_dlg.noteA2}
...
function jwl_pass_form_data () {
  ...
  var name = jwl_target = document.a_tag.target.value;
...
<div class="mceActionPanel">
  ...
  <input type="button" id="insert" name="insert" value="{#insert}" onClick="jwl_pass_form_data();tinyMCE.execCommand('mceInsertContent',false,'<a href=\'' + jwl_href + '\' target=\'' + jwl_target + '\'>' + jwl_sel_content4 + '</a>');tinyMCEPopup.close();" />&nbsp;
